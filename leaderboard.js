...
Elm.Leaderboard = Elm.Leaderboard || {};
Elm.Leaderboard.make = function (_elm) {
   "use strict";
   _elm.Leaderboard = _elm.Leaderboard || {};
   if (_elm.Leaderboard.values) return _elm.Leaderboard.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = $Html.text("Hello, nurse!");
